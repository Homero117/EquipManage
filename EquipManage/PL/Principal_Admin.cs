...
namespace EquipManage.PL
{
    public partial class Principal_Admin : Form
    {
        ...
        {
            Recepción_EntregaDeEquipos_ITEMS_Admin recepción_EntregaDeEquipos_ITEMS_Admin = new Recepción_EntregaDeEquipos_ITEMS_Admin();
            recepción_EntregaDeEquipos_ITEMS_Admin.Show();
            this.Close();
        }
